...
export default {
    ...
    // emits: ['custom-event', 'range-changed', 'sidebar-transform', 'layer-meta-props', 'drawing-mode-off', 'change-settings', 'remove-tool', 'object-selected', 'scroll-lock', 'cursor-changed', 'register-kb-listener'],
    emits: [
                'custom-event',
        'range-changed',
        'rezoom-range',
